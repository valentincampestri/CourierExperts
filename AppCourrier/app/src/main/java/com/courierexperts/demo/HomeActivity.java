...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (btnCompras != null) {
            btnCompras.setOnClickListener(v -> startActivity(new Intent(HomeActivity.this, PurchasesActivity.class)));
        }
        if (btnPaquetes != null) {
            btnPaquetes.setOnClickListener(v -> startActivity(new Intent(HomeActivity.this, PackagesActivity.class)));
        }
        if (btnEnvios != null) {
            btnEnvios.setOnClickListener(v -> startActivity(new Intent(HomeActivity.this, ShipmentsActivity.class)));
        }
