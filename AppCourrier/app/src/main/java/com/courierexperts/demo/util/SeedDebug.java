    ...
    public static void seedNow(Context ctx) {
        try {
            ...
            if (uid == null || uid.isEmpty()) {
                Toast.makeText(ctx, "Seed: uid no disponible (inicia sesiÃ³n)", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            batch.commit()
                    ...
                    .addOnFailureListener(e -> Toast.makeText(ctx, "Seed fallÃ³: " + e.getMessage(), Toast.LENGTH_LONG).show());
        } catch (Exception e) {
